...
Run from repo root with PYTHONPATH=. and the conda `auto` python:
    PYTHONPATH=. $PY scripts/annotate/spike_topdown.py --list-seqs --capture captures/raw/ai_session/run_3/game1/game1.jsonl
...
DEFAULT_CAPTURE = "captures/raw/ai_session/run_3/game1/game1.jsonl"
