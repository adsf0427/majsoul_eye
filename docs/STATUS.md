...
`test_tiles / test_replay / test_sync / test_label / test_classifier / test_mycv_baseline / test_quality / test_coords / test_annotate_pipeline / test_annotate_frame`
（§1.13：`test_river`/`test_meld` 随 `label/river.py`·`meld.py` 一并删除。）
