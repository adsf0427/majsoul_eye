...
> 最后更新对应进度：**HUD 检测（分数/场风/局/余牌/供托/本场/动作按钮/立直棒）代码落地——56 类
...
### 1.43 build 提速：annotate HSV 一次转换 + build_dataset 免重编码；INTER_LINEAR 实测否决（2026-07-07）
...
### 1.44 HUD 标签三修：wall_count 固定框+补零、reach fill 门限缩至声明窗口、按钮框扩成 banner（2026-07-07）
