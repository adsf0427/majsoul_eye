...
### 测试（12 套全绿，conda `auto` 环境）
`test_tiles / test_replay / test_sync / test_label / test_river / test_meld / test_classifier / test_mycv_baseline / test_quality / test_coords / test_annotate_pipeline / test_annotate_frame`
