...
> 最后更新对应进度：**采集统一 AI 路线 + 管线梳理收官 + 数据集版本化**（§1.19–§1.22，2026-07-04）。
...
采集与迁移（autoplay_gt/autoplay_stability/schema_writer/roi_diff/migrate_ai/mjcopilot_gt/paths/
downstream_rewire）、质量门（quality/build_gate/consistency/consistency_golden/purge_occlusion）、
